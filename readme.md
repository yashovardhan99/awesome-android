...
- [TimeIt](https://github.com/yashovardhan99/timeit) - A simple and easy to use stopwatch library for android which makes it easy to start, pause, display and maintain multiple stopwatches in an app.
